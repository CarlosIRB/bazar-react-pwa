...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Bazar Universal PWA Carlos Ismael Ramirez Bello",
        short_name: "BazarPWACarlosIsmaelRamirezBello",
        description: "Bazar Universal PWA hecho por Carlos Ismael Ramirez Bello",
        theme_color: "#118f0c",
        background_color: "#737bdc",
        icons: [
          {
